...
public class ChatController {
  ...
  @Autowired private HuggingApi imageService;
  ...
  public ResponseEntity<CricketResponse> getCricketResponse(
      @RequestParam("inputText") String inputText) throws JsonProcessingException {
  ...
  // defaultValue = "500x500") String size,
  //                                       @RequestParam(value = "numberOfImages", required = false,
  // defaultValue = "2") int numbers) throws IOException {
