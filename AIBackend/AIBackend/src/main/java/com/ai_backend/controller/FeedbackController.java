...
public class FeedbackController {
  ...
  @PostMapping("/rate")
  public FeedbackRating submitRating(@RequestParam Long questionId, @RequestParam int rating) {

    return service.saveRating(questionId, rating);
  }

  @PostMapping("/submit")
  public ResponseEntity<String> submitFeedback(@RequestBody List<FeedbackRatingRequest> ratings) {
